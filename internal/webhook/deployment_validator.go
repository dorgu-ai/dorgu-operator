...
func (v *DeploymentValidator) Handle(ctx context.Context, req admission.Request) admission.Response {
	...
	warnings = append(warnings, validateWebhookResources(matchingPersona, deploy)...)
	w, e := validateWebhookReplicas(matchingPersona, deploy)
	warnings = append(warnings, w...)
	errors = append(errors, e...)
	errors = append(errors, validateWebhookSecurity(matchingPersona, deploy)...)
	warnings = append(warnings, validateWebhookProbes(matchingPersona, deploy)...)
...
func validateWebhookResources(persona *dorguv1.ApplicationPersona, deploy *appsv1.Deployment) []string {
...
func validateWebhookReplicas(persona *dorguv1.ApplicationPersona, deploy *appsv1.Deployment) ([]string, []string) {
...
func validateWebhookSecurity(persona *dorguv1.ApplicationPersona, deploy *appsv1.Deployment) []string {
...
func validateWebhookProbes(persona *dorguv1.ApplicationPersona, deploy *appsv1.Deployment) []string {
